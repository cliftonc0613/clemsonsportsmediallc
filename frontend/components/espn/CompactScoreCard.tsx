    ...
    >
      ...
      <div className="flex items-center justify-center gap-4 md:gap-6">
        ...
        <div className="flex items-center gap-3 md:gap-4">
          {/* Rank + Team Name + Record - desktop only (1320px+) */}
          <div className="hidden min-[1320px]:block text-right">
        ...
        <div className="flex items-center gap-3 md:gap-4">
          ...
          {/* Team Name + Record - desktop only (1320px+) */}
          <div className="hidden min-[1320px]:block text-left">
