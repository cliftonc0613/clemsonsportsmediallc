...
export const metadata: Metadata = {
  title: `Softball Schedule 2026 | ${SITE_NAME}`,
  description: "Clemson Tigers Softball 2026 schedule with game times, opponents, and results.",
  openGraph: {
    title: `Softball Schedule 2026 | ${SITE_NAME}`,
    description: "Clemson Tigers Softball 2026 schedule with game times, opponents, and results.",
    type: "website",
    url: `${SITE_URL}/schedule/softball`,
  },
};
    ...
    <>
      ...
      <BreadcrumbSchema
        items={[
          ...
          { name: "Softball", url: `${SITE_URL}/schedule/softball` },
        ]}
      />
      ...
      <section className="bg-[var(--clemson-dark-purple)] pt-10 pb-4 md:pt-32 md:pb-16 relative overflow-hidden">
        ...
        <div
          ...
          style={{ backgroundImage: "url('/images/hero-softball.jpg')" }}
        />
        {/* Dark Overlay */}
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="relative z-10 text-center">
            ...
            <nav className="text-base md:text-lg text-gray-300 uppercase">
              ...
              <span className="mx-2">/</span>
              <span className="text-[var(--clemson-orange)]">Softball</span>
            </nav>
          </div>
        </div>
      </section>
