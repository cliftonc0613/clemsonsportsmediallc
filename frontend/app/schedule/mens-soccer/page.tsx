...
const SCHEDULE_2025_26: ScheduleGame[] = [
  // Fall 2025 - Exhibition Games
  {
    ...
    date: "2025-08-09",
    time: "6:00 PM",
    opponent: { name: "Charlotte", abbreviation: "CLT", logo: "https://a.espncdn.com/i/teamlogos/soccer/500/7137.png" },
    isHome: true,
  ...
  // Spring 2026
  {
    ...
    date: "2026-02-18",
    time: "7:00 PM",
    opponent: { name: "Portland Hearts of Pine", abbreviation: "PHP" },
    isHome: true,
    venue: "Historic Riggs Field",
    location: "Clemson, S.C.",
    isConference: false,
  ...
  },
  {
    ...
    date: "2026-03-07",
    time: "6:00 PM",
    opponent: { name: "Greenville Triumph", abbreviation: "GVL" },
    isHome: true,
    venue: "Historic Riggs Field",
    location: "Clemson, S.C.",
    isConference: false,
  ...
  },
  {
    ...
    date: "2026-03-28",
    time: "2:00 PM",
    opponent: { name: "Crown Legacy", abbreviation: "CLF" },
    isHome: false,
