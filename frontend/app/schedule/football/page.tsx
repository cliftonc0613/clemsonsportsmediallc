...
export const metadata: Metadata = {
  title: `Football Schedule 2026 | ${SITE_NAME}`,
  description: "Clemson Tigers Football 2026 schedule with game times, opponents, and results.",
  openGraph: {
    title: `Football Schedule 2026 | ${SITE_NAME}`,
    description: "Clemson Tigers Football 2026 schedule with game times, opponents, and results.",
    type: "website",
    url: `${SITE_URL}/schedule/football`,
  },
};
...
export default async function FootballSchedulePage() {
  ...
  try {
    const [schedule, teamInfo] = await Promise.all([
      getSchedule("football"),
      getSimpleTeamInfo("football"),
    ]);
    if (schedule?.events) {
    ...
    <>
      ...
      <BreadcrumbSchema
        items={[
          ...
          { name: "Football", url: `${SITE_URL}/schedule/football` },
        ]}
      />
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="relative z-10 text-center">
            ...
            <nav className="text-base md:text-lg text-gray-300 uppercase">
              ...
              <span className="mx-2">/</span>
              <span className="text-[var(--clemson-orange)]">Football</span>
            </nav>
          </div>
        </div>
      </section>
